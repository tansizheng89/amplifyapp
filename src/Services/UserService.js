...
const STUDENT_API_BASE_URL = "http://54.236.250.253:8080/webapp/api/user";
...
class StudentDataService {
  ...
  upload(file, onUploadProgress) {
    ...
    return axios.post("http://54.236.250.253:8080/webapp/api/file/upload", formData, {
      headers: {
        "Content-Type": "multipart/form-data",
      },
      onUploadProgress,
  ...
  getFiles() {
    return axios.get("hhttp://54.236.250.253:8080/webapp/api/file/files",token());
  }

  getAvatarFiles(id) {
    return axios.get("http://54.236.250.253:8080/webapp/api/user/applicant/avatarweb/"+id,token());
  }
