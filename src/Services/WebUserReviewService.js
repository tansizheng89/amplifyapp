...
const WEBUSERJOB_API_BASE_URL = "http://54.236.250.253:8080/webapp/api/review/";
...
function processRefreshToken(){
  axios.get("http://54.236.250.253:8080/webapp/user/refreshtoken",refreshToken()).then(response=>{
